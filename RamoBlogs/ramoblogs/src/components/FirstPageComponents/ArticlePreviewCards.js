...
import ArticlePrewievCard from "./ArticlePreviewCard";
...
function ArticlePreviewCards() {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:5000/api/article/cards/getall")
  ...
  return (
    <div className="min-h-screen bg-gray-800 flex flex-col mt-10 ">
      <div className="flex flex-col gap-y-2">
        <h2 className=" bg-gray-900 font-bold text-2xl text-center py-1 text-white ">
          Articles
        </h2>
...
export default ArticlePreviewCards;
