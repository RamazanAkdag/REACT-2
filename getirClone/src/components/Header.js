...
export default function Header() {
  return (
    <div className="bg-brand-color rounded-t-lg">
      <div className="container mx-auto h-11 flex items-center justify-between ">
        <a href="#">
          <img
            ...
            alt="Getir"
            className="style__Image-sc-__sc-1h9bp23-0 jFLMaM"
          />
        </a>
        <nav className="flex gap-x-8 text-sm font-semibold">
          <a
            href="#"
            className="text-white text-opacity-80 transition-all hover:text-opacity-100 flex items-center"
          >
            <BiGlobe size={20}></BiGlobe>
            Türkçe (TR)
          </a>
          <a
            href="#"
